...
from btpy.builtins.fallbacks import Fallback
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (NodeStatus.FAILURE, NodeStatus.SUCCESS, NodeStatus.SUCCESS),
        (NodeStatus.SKIPPED, NodeStatus.SKIPPED, NodeStatus.FAILURE),
    ],
)
